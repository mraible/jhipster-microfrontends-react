...
export const Post = (props: IPostProps) => {
  ...
  return (
    <div>
      <h2 id="post-heading">
        <Translate contentKey="gatewayApp.blogPost.home.title">Posts</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="gatewayApp.blogPost.home.createLabel">Create new Post</Translate>
        </Link>
      </h2>
          ...
          {postList && postList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('title')}>
                    <Translate contentKey="gatewayApp.blogPost.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('content')}>
                    <Translate contentKey="gatewayApp.blogPost.content">Content</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('date')}>
                    <Translate contentKey="gatewayApp.blogPost.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="gatewayApp.blogPost.blog">Blog</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="gatewayApp.blogPost.home.notFound">No Posts found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
