...
export const TagUpdate = (props: ITagUpdateProps) => {
  ...
  const { tagEntity, posts, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.blogTag.home.createOrEditLabel">
            <Translate contentKey="gatewayApp.blogTag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
