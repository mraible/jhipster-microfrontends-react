...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes([REQUEST(ACTION_TYPES.FETCH_POST_LIST), REQUEST(ACTION_TYPES.FETCH_POST)], {}, state => {
        expect(state).toMatchObject({
          errorMessage: null,
          updateSuccess: false,
          loading: true,
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.FETCH_POST),
          FAILURE(ACTION_TYPES.CREATE_POST),
          FAILURE(ACTION_TYPES.UPDATE_POST),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.UPDATE_POST actions', async () => {
      const expectedActions = [
        ...
        {
          type: SUCCESS(ACTION_TYPES.UPDATE_POST),
          payload: resolvedObject,
        },
      ];
